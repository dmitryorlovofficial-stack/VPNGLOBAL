...
export default function UsersPage() {
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Форма создания */}
            {showCreate && (
                <form onSubmit={handleCreate} className="bg-dark-800 border border-dark-700 rounded-xl p-5 space-y-4">
                            ...
                            <div className="flex gap-2">
                                <div className="relative flex-1">
                                    <input
                                        ...
                                        className="w-full bg-dark-700 border border-dark-600 rounded-lg px-3 py-2 pr-9 text-sm text-white focus:outline-none focus:border-blue-500"
                            ...
                            <tr key={user.id} className="border-b border-dark-700/50 hover:bg-dark-700/30">
                                ...
                                <td className="px-4 py-3">
                                    <span className={`px-2 py-0.5 rounded text-xs font-medium ${
                                        user.role === 'admin' ? 'bg-red-600/20 text-red-400' : 'bg-blue-600/20 text-blue-400'
                                    }`}>
                                            ...
                                            {editId === user.id ? (
                                                <>
                                                    <div className="flex items-center gap-1">
                                                        ...
                                                        <button onClick={handleGenEditPassword} className="p-1.5 text-gray-400 hover:text-blue-400 hover:bg-dark-600 rounded" title="Сгенерировать">
                                                ...
                                                <>
                                                    <button onClick={() => startEdit(user)} className="p-1.5 text-blue-400 hover:bg-dark-600 rounded" title="Редактировать">
