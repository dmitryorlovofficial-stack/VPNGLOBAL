                            ...
                            <div key={t.id} className="flex items-center justify-between bg-dark-700/50 rounded-lg px-4 py-3">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-3 text-xs text-gray-400 mt-0.5">
                                            {/* Бейдж типа связи */}
                                            <span className={isXray ? 'text-purple-400 font-medium' : 'text-accent-400 font-medium'}>
                                                {isXray ? 'Xray' : 'WG'}
                                            </span>
                                ...
                                <div className="flex items-center gap-1">
                                    ...
                                    <button
                                        ...
                                        disabled={actionLoading === t.id}
                                        className="p-1.5 text-gray-400 hover:text-accent-400 rounded-lg hover:bg-dark-600"
                                        title="Перезапустить"
                                    >
